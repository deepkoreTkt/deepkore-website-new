        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-between max-w-7xl mx-auto">
          ...
          <div className="flex lg:flex-col gap-2 w-full lg:w-2/5 space-y-1 h-[500px]">
            {features.map((feature, idx) => (
              <button
                key={feature.title}
                className={`text-left w-full py-3 px-6 rounded-lg transition-all duration-300 relative overflow-hidden group ${
                  activeTab === idx
          ...
          >
            <div className="bg-[#264a67] rounded-2xl shadow-2xl p-4 max-w-4xl border border-[#264a67] h-[500px]">
