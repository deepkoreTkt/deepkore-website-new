          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <div className="relative">
              <motion.button
                ...
                className="flex items-center space-x-1 px-4 py-2 text-gray-700 hover:text-gray-900 font-medium text-sm transition-colors duration-200 rounded-full hover:bg-gray-50"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                  ...
                  >
                    {userGuideItems.map((item, index) => (
                      <motion.a
                        key={item.href}
                        href={item.href}
                        className="block px-4 py-3 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-colors duration-200"
