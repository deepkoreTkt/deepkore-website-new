  ...
  const milestones = [
    {
      year: '2020',
      title: 'Foundation',
      description: 'Nexus AI was founded with a vision to democratize artificial intelligence.',
      icon: '🚀'
    },
    {
      year: '2021',
      title: 'First Breakthrough',
      description: 'Launched our first neural network model, revolutionizing creative workflows.',
      icon: '🧠'
    },
    {
      year: '2022',
    ...
    },
    {
      ...
      description: 'Released advanced computer vision capabilities with unprecedented accuracy.',
      icon: '👁️'
    },
    {
      year: '2024',
      title: 'Enterprise Solutions',
      description: 'Launched enterprise-grade AI solutions for Fortune 500 companies.',
      icon: '🏢'
    },
    {
      year: '2025',
      title: 'Neural Vision 3.5',
      description: 'Current generation with cutting-edge multimodal AI capabilities.',
      icon: '⚡'
    }
  ];
            ...
            >
              {activeTab === 'mission' && (
                <div className="text-center">
                  <motion.div
                    className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-700/50"
                  ...
                  >
                    ...
                    <p className="text-xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8">
                      We believe that artificial intelligence should be accessible to everyone, not just large corporations.
                      Our mission is to create intuitive, powerful AI tools that empower creators, entrepreneurs, and innovators
                      to bring their ideas to life faster and more efficiently than ever before.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                      {[
                        { icon: '🚀', title: 'Innovation', desc: 'Pushing AI boundaries' },
                        { icon: '🌍', title: 'Accessibility', desc: 'AI for everyone' },
                        { icon: '⚡', title: 'Efficiency', desc: 'Faster workflows' }
                      ].map((item, index) => (
                        <motion.div
                          key={index}
                      ...
                      {milestones.map((milestone, index) => (
                        ...
                        >
                          <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                            <motion.div
                              className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50"
                              whileHover={{ scale: 1.05 }}
                              transition={{ type: "spring", stiffness: 300 }}
                            >
                          ...
                          <div className="relative">
                            <motion.div
                              className="w-4 h-4 bg-gradient-to-r from-blue-500 to-green-500 rounded-full border-4 border-slate-900"
