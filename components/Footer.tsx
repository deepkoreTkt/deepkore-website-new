...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/10 via-transparent to-green-900/10"></div>
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-lg leading-relaxed max-w-md">
                  Empowering creative entrepreneurs with cutting-edge AI tools to transform ideas into reality.
                </p>
              </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      key={social.name}
                      href={social.href}
                      className={`p-3 bg-slate-800/50 rounded-xl text-gray-400 ${social.color} transition-all duration-300 backdrop-blur-sm border border-slate-700/50 hover:border-slate-600 hover:bg-slate-700/50`}
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-all duration-300"
                    required
                  />
                </div>
                <motion.button
