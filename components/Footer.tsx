...
const Footer: React.FC = () => {
  ...
  const solutionLinks = [
    { name: "Sales & CRM", href: "/solution/sales" },
    { name: "Asset Management", href: "/solution/assetmanagement" },
    { name: "Manufacturing &     Production", href: "/solution/manufacturing" },
    { name: "Healthcare & Medical", href: "/solution/healthcare" },
