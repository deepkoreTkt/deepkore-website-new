          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {challenges.map((challenge, index) => (
                <motion.div
                  key={index}
                  className={`${challenge.bgColor} backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300 group`}
                ...
                >
                  <div className="mb-4">
                    {getIcon(
                      challenge.icon,
                      `text-4xl md:text-5xl group-hover:scale-110 transition-transform duration-300 ${challenge.iconColor}`
                    )}
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {solutions.map((solution, index) => (
                <motion.div
                  key={index}
                  className={`${solution.bgColor} backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-blue-200/50 shadow-lg hover:shadow-xl transition-all duration-300 group`}
                  whileHover={{ scale: 1.02, y: -5 }}
                  initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                ...
                >
                  <div className="mb-4">
                    {getIcon(
                      solution.icon,
                      `text-4xl md:text-5xl group-hover:scale-110 transition-transform duration-300 ${solution.iconColor}`
                    )}
                  </div>
                  <h4 className="text-lg md:text-xl font-bold text-black mb-3 leading-tight">
                    {solution.title}
