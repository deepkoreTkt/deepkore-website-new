  ...
  const keyFeatures = [
    {
      ...
      description:
        "Comprehensive patient registration, profiles, and relationship management with integrated health records.",
      features: [
    ...
    },
    {
      ...
      description:
        "Intelligent scheduling system with automated reminders, resource allocation, and waitlist management.",
      features: [
        "Smart scheduling",
        "Automated reminders",
    ...
    },
    {
      ...
      description:
        "Secure, compliant EHR system with real-time access to patient data, treatment plans, and medical notes.",
      features: [
    ...
    },
    {
      ...
      description:
        "Virtual care capabilities with video consultations, remote monitoring, and secure patient communication.",
      features: [
        "Video consultations",
    ...
    },
    {
      ...
      description:
        "Automated billing workflows, insurance claims processing, and revenue cycle management.",
      features: [
        "Automated billing",
        "Insurance claims",
        "Payment processing",
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant workflows ensuring data security, audit trails, and regulatory compliance.",
      features: [
        "HIPAA compliance",
        "Audit trails",
        "Data encryption",
  ...
  const challenges = [
    {
      ...
      description:
        "Inefficient paper records lead to lost information, delays, and compliance risks.",
    ...
    },
    {
      ...
      description:
        "Poor scheduling and resource allocation result in patient dissatisfaction and lost revenue.",
    ...
    },
    {
      ...
      description:
        "Navigating HIPAA and other regulations creates administrative burden and compliance gaps.",
    ...
    },
    {
      ...
      description:
        "Difficulty managing staffing levels, scheduling, and workload distribution efficiently.",
    ...
    },
    {
      ...
      description:
        "Manual billing processes lead to errors, delays in payments, and revenue leakage.",
    ...
    },
    {
      ...
      title: "Data Silos",
      description:
        "Disconnected systems prevent comprehensive patient care and informed decision-making.",
  ...
  const useCases = [
    {
      ...
      description:
        "Comprehensive hospital operations management from patient admission to discharge with integrated care coordination.",
      image:
    ...
    },
    {
      ...
      description:
        "Streamline clinic workflows with appointment scheduling, patient management, and billing automation.",
      image:
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  ...
                  platform. Manage patients, appointments, records, and billing
                  from a single, compliant solution that puts patients first.
                </motion.p>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-gray-200/50">
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src =
                          "data:image/svg+xml;base64,";
                      }}
                    />
