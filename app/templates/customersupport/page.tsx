...
const CustomerSupport = () => {
  ...
  const templates = [
    ...
    },
    {
      ...
      subtitle: "Optimize Support Operations",
      description:
        "Manage support teams with workload balancing, skill-based routing, training tracking, and performance optimization.",
      icon: <Users className="w-8 h-8" />,
  ...
  return (
    <div className="relative min-h-screen bg-[#f2f5f5]">
      ...
      <div className="relative z-10 container mx-auto px-40 lg:px-40 py-24">
        ...
        >
          <motion.h1
            className={`${inter.className} text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight text-center px-20`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
