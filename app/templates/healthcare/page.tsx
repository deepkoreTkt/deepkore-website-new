...
const Healthcare = () => {
  ...
  const templates = [
    ...
    },
    {
      ...
      subtitle: "Patient Safety & Quality",
      description:
        "Monitor and improve healthcare quality with patient safety tracking, quality metrics, and continuous improvement programs.",
      icon: <Settings className="w-8 h-8" />,
