...
const Engineering = () => {
  const ratings = [4.8, 4.6, 4.9, 4.3, 4.7, 4.1, 4.5, 4.4, 4.2, 4.8];

  const templates = [
    {
      title: "Engineering Workflow Manager",
    ...
    },
    {
      ...
      subtitle: "Collaborative Code Quality",
      description:
        "Manage code reviews with automated checks, reviewer assignment, and feedback tracking for consistent code quality.",
    ...
    },
    {
      ...
      description:
        "Implement continuous integration and deployment with automated testing, build processes, and deployment pipelines.",
    ...
    },
    {
      ...
      description:
        "Automate testing processes with unit tests, integration tests, and performance testing for reliable software delivery.",
      icon: <Settings className="w-8 h-8" />,
    ...
    },
    {
      ...
      description:
        "Track engineering projects with sprint management, task assignment, and progress monitoring for efficient delivery.",
    ...
    },
    {
      ...
      description:
        "Implement quality gates with automated checks, security scanning, and compliance verification for production-ready code.",
    ...
    },
    {
      ...
      subtitle: "Reliable Software Deployment",
      description:
        "Manage software deployments with version control, environment management, and automated rollback capabilities.",
    ...
    },
    {
      ...
      description:
        "Automate infrastructure provisioning, configuration management, and monitoring with DevOps best practices.",
      icon: <Zap className="w-8 h-8" />,
    ...
    {
      title: "Code Quality",
      subtitle: "Maintainable Code Standards",
      description:
        "Ensure code quality with linting, static analysis, and automated refactoring suggestions for maintainable software.",
      icon: <Settings className="w-8 h-8" />,
    ...
    },
    {
      ...
      description:
        "Track engineering metrics with cycle time analysis, defect tracking, and productivity insights for continuous improvement.",
      icon: <BarChart3 className="w-8 h-8" />,
    ...
    <div className="relative min-h-screen bg-[#f2f5f5]">
      ...
      <div className="relative z-10 container mx-auto px-40 lg:px-40 py-24">
        ...
        >
          ...
          >
            Streamline Development Processes with
          ...
          >
            Optimize engineering workflows with code reviews, CI/CD pipelines,
            testing automation, and project tracking.
          </motion.p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-left">
                ...
                <p className="text-gray-600">
                  ...
                  discuss your specific engineering requirements.
                </p>
              </div>
