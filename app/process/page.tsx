    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 md:pt-24 lg:pt-32 pb-12 md:pb-16 lg:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <div className="text-center mt-10 mb-8 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-xl md:text-2xl lg:text-4xl font-semibold text-gray-700 mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
            <a href="/getstarted">
              <button className="group relative bg-gradient-to-r from-[#00A551] to-[#2791D0] text-white px-6 md:px-10 py-3 md:py-5 rounded-2xl font-bold text-base md:text-lg shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden">
            ...
            <a href="/contact">
              <button className="group border-2 border-[#00A551] text-[#00A551] px-6 md:px-10 py-3 md:py-5 rounded-2xl font-bold text-base md:text-lg hover:bg-[#00A551] hover:text-white transition-all duration-500 shadow-lg hover:shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center group">
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-white/20 hover:border-[#2791D0]/50 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-[#2791D0]/20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group bg-white rounded-3xl shadow-xl p-6 md:p-8 hover:shadow-3xl transition-all duration-500 border border-gray-100 overflow-hidden relative"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl md:text-2xl font-bold text-gray-800 group-hover:text-[#00A551] transition-colors duration-300">
                        {feature.title}
                      </h3>
                      {/* Progress indicator */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-800 group-hover:text-[#00A551] transition-colors duration-300">
                Design
              </h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-800 group-hover:text-[#2791D0] transition-colors duration-300">
                Automate
              </h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-10 lg:gap-12">
            {workflowTools.map((tool, idx) => (
              ...
              >
                ...
                {/* Content Section */}
                <div className="relative z-10 p-6 md:p-8 lg:p-12 flex-1">
                  <div className="flex items-start mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 group-hover:text-[#00A551] transition-colors duration-300">
                        {tool.title}
                      </h3>
                  ...
                  <a href="/getstarted">
                    <button className="inline-flex items-center px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-[#00A551] to-[#2791D0] text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-sm md:text-base">
                      Learn More
                ...
                {/* Image Section */}
                <div className="relative z-10 flex-1 p-6 md:p-8 lg:p-12 w-full">
                  <div className="relative w-full h-64 md:h-80 lg:h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl overflow-hidden shadow-inner border border-gray-300/50 group-hover:shadow-xl transition-shadow duration-500">
                    ...
                    <div className="absolute bottom-2 md:bottom-4 left-2 md:left-4 right-2 md:right-4 bg-white/90 backdrop-blur-sm rounded-lg p-2 md:p-3 shadow-md">
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-[#00A551] to-[#2791D0] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-6 md:mb-8 text-[#ffffff]/80">
            Join thousands of businesses already using Deepkore to streamline
            their operations
          </p>
          <a href="/getstarted">
            <button className="bg-[#ffffff] text-[#00A551] px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-base md:text-lg hover:bg-[#ffffff]/90 transition-all duration-300 shadow-xl hover:shadow-2xl">
              Get Started
            </button>
          </a>
        </div>
